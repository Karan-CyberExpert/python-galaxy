...
const testimonials = [
  {
    ...
    avatar: 'PS',
    text: 'This bootcamp changed my career! From complete beginner to landing my first dev job in just 3 months.',
  ...
  },
  {
    ...
    role: 'Data Analyst',
    avatar: 'RV',
    text: 'The project-based approach made learning Python so practical. Now I automate everything at work!',
  ...
  },
  {
    ...
    avatar: 'AP',
    text: 'Best investment I made! The instructors are incredible and the community support is amazing.',
  ...
  },
  {
    ...
    role: 'Freelancer',
    avatar: 'AR',
    text: 'Started freelancing with Python after this course. Already made back 10x the course fee!',
  ...
  },
  {
    ...
    role: 'AI Enthusiast',
    avatar: 'SI',
    text: 'Perfect foundation for my AI journey. The concepts are explained so clearly and simply.',
  ...
  },
  {
    ...
    avatar: 'KK',
    text: 'Built my startup MVP using skills from this bootcamp. Highly recommend to entrepreneurs!',
